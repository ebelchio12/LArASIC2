...
#get ENC gain files
files = glob('./**/Gain_Lin_raw_900mV*.csv', recursive=True)
...
#'''
nbins=10
xtitle='INL gain (900mV) @0.5$\mu$s, Total channels: %1.0f'%(total_channels)
ytitle='Counts'
unit=''
saveTo='./test-plots/inl_gain_900mV_0.5us-outliers-included.png'
...
#'''
nbins=10
xtitle='INL gain (900mV) @1$\mu$s, Total channels: %1.0f'%(total_channels)
ytitle='Counts'
unit=''
saveTo='./test-plots/inl_gain_900mV_1us-outliers-included.png'
...
#'''
nbins=10
xtitle='INL gain (900mV) @2$\mu$s, Total channels: %1.0f'%(total_channels)
ytitle='Counts'
unit=''
saveTo='./test-plots/inl_gain_900mV_2us-outliers-included.png'
...
#'''
nbins=10
xtitle='INL gain (900mV) @3$\mu$s, Total channels: %1.0f'%(total_channels)
ytitle='Counts'
unit=''
saveTo='./test-plots/inl_gain_900mV_3us-outliers-included.png'
