...
#'''
nbins=10
xtitle='Gain (900mV) @0.5$\mu$s (e-/LSB), Total channels: %1.0f'%(total_channels)
ytitle='Counts'
unit=''
saveTo='./test-plots/gain_900mV_0.5us-outliers-included.png'
...
#'''
nbins=10
xtitle='Gain (900mV) @1$\mu$s (e-/LSB), Total channels: %1.0f'%(total_channels)
ytitle='Counts'
unit=''
saveTo='./test-plots/gain_900mV_1us-outliers-included.png'
...
#'''
nbins=10
xtitle='Gain (900mV) @2$\mu$s (e-/LSB), Total channels: %1.0f'%(total_channels)
ytitle='Counts'
unit=''
saveTo='./test-plots/gain_900mV_2us-outliers-included.png'
...
#'''
nbins=10
xtitle='Gain (900mV) @3$\mu$s (e-/LSB), Total channels: %1.0f'%(total_channels)
ytitle='Counts'
unit=''
saveTo='./test-plots/gain_900mV_3us-outliers-included.png'
